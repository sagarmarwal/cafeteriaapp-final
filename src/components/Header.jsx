        ...
        <header className='fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary'>
            ...
            <div className='hidden md:flex w-full h-full items-center justify-between'>
                <div className="flex items-center gap-2">
                    <img src={Logo} alt="logo" className="w-24 object-cover" onClick={ () => window.location.reload } />
                ...
                <div className="flex items-center gap-8">
                    ...
                    <motion.div whileTap={{ scale: 0.6 }} className=' relative flex items-center justify-center'>
                            ...
                            <p className='text-xs text-white font-semibold'>{cartSize}</p>
                        </div>
                                    </div>
                        </Link>
                                    ) : <MdShoppingBasket className='text-textColor text-2xl cursor-pointer hover:text-cartNumBg transition-all ease-in-out'/>
                    ...
                    <div className='relative'>
                        <img whileTap={{ scale: 0.6 }} src={user ? user?.photoURL : Avatar} alt="userprofile" className='w-8 min-w-[40px] h-8 min-h-[40px] drop-shadow-xl cursor-pointer rounded-full' onClick={login} />
                        {
                            isMenu && (
